...
function EventTimeline(props: EventTimelineProps) {
  ...
  return (
    <Timeline color="midnight" active={8} bulletSize={45} lineWidth={4}>
      <Timeline.Item
        bullet={<Image src="/timeline-icons/collection.svg" w={50} />}
        title={
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/accession.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Accession
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/subsampling.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Subsampling
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/extraction.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            DNA extraction
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/sequencing.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/assembly.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Sequence assembly
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/annotation.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Sequence annotation
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/deposition.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Data deposition
          </Text>
      ...
      <Timeline.Item
        bullet={<Image src="/timeline-icons/data-reuse.svg" w={50} />}
        title={
          <Text fz="sm" ml={20} fw={700}>
            Data reuse
          </Text>
