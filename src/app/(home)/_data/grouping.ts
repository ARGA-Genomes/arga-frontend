...
export const grouping: BrowseItem[] = [
  {
    total: "sources.ARGA_Commercial_Species",
  ...
  {
    total: "sources.ARGA_Venomous_and_Poisonous_Species",
